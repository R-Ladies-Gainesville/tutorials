...
See the [presentations repository] to download the the R Markdown file `tutorials_template.Rmd`. This presentation is created with the [xaringan](https://slides.yihui.org/xaringan/#1) package and the RLadies theme by [Alison Hill](https://www.apreshill.com/project/rladies-xaringan/) for more guidance.
